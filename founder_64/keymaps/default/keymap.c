...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_all(
      ...
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
               MO(_UP), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  
               KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   KC_RSFT,
      KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                    MO(_DN), KC_BSPC,          KC_MUTE, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    /* Down */
    [_UP] = LAYOUT_all(
    ...
    [_DN] = LAYOUT_all(
      ...
      _______, _______, _______, _______, _______, _______,          _______, _______, KC_UP,    _______, _______, _______, _______, _______,
               _______, _______, _______, _______, _______, _______, KC_PSCR, KC_LEFT, KC_DOWN,  KC_RGHT, _______, _______, _______,
